var productController = function () {
    ...
    function registerEvents() {
        ...
        $('#ddlShowPage').on('change', function () {
            dyu.configs.pageSize = $(this).val();
            dyu.configs.pageIndex = 1;
            loadData(true);
        });
    ...
    function loadData(isPageChanged) {
        ...
        $.ajax({
            ...
            data: {
                ...
                page: dyu.configs.pageIndex,
                pageSize: dyu.configs.pageSize
            },
    ...
    function wrapPaging(recordCount, callBack, changePageSize) {
        var totalsize = Math.ceil(recordCount / dyu.configs.pageSize);
